...
public class PromotionManagerImpl implements PromotionManager {
     ...
     */
    public PromotionDetails applyPromotion(double price, int quantity, List<Long> promotionCodes) {
        ...
        if (promotionId == 1) {
            ...
            return new PromotionDetails(price, quantity, 0);
        }
    }
     ...
     */
    private PromotionDetails applyPromotion1(double price, int quantity, int promotionId) {
        ...
        return new PromotionDetails(updatedPrice, updatedQty, promotionId);
    }

    /** Apply promotion 3 for the price of 2 on Oranges */
    private PromotionDetails applyPromotion2(double price, int quantity, int promotionId) {
        ...
        return new PromotionDetails(updatedUnitprice, updatedQuantity, promotionId);
    }
}
