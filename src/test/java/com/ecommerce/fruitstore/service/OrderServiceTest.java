...
public class OrderServiceTest {
    ...
    public void testCreateOrderWithApplesAndOranges() {
        ...
        when(promotionManager.applyPromotion(0.6, 3, Collections.emptyList())).thenReturn(new PromotionDetails(0.6, 3, 0));
        when(promotionManager.applyPromotion(0.25, 2, Collections.emptyList())).thenReturn(new PromotionDetails(0.25, 2, 0));
        ...
        OrderSummary summary = orderService.createOrder(new OrderRequest(3, 2, Collections.emptyList(), Collections.emptyList()));
    ...
    public void testCreateOrderWithApplesOnly() {
        ...
        OrderService orderService = new OrderServiceImpl(orderRepository, pricingService, promotionManager);
        OrderSummary summary = orderService.createOrder(new OrderRequest(3, 0, Collections.emptyList(), Collections.emptyList()));
        assertNotNull(summary);
    ...
    public void testCreateOrderWithOrangesOnly() {
        ...
        OrderSummary summary = orderService.createOrder(new OrderRequest(0, 2, Collections.emptyList(), Collections.emptyList()));
        assertNotNull(summary);
    ...
    public void testCreateWithNoItems() {
        ...
        OrderSummary summary = orderService.createOrder(new OrderRequest(0, 0, Collections.emptyList(), Collections.emptyList()));
        assertNotNull(summary);
    ...
    public void testCreateOrderWithApplesAndOrangePromotions() {
        ...
        OrderSummary summary = orderService.createOrder(new OrderRequest(3, 3, List.of(1L), List.of(2L)));
        assertNotNull(summary);
        assertNotNull(summary.getOrderId());
        assertEquals(1L, summary.getOrderId());
        assertTrue(summary.getTotalPrice().equals(NumberFormatter.formatBigDecimal(2.56)));
    ...
    public void testCreateOrderWithApplesAndOrangesWithOnlyApplePromotion() {
        ...
        OrderSummary summary = orderService.createOrder(new OrderRequest(6, 2, List.of(1L), Collections.emptyList()));
        assertNotNull(summary);
        assertNotNull(summary.getOrderId());
        assertEquals(1L, summary.getOrderId());
